...
// ]]>');
?>
<div class="kblock kannouncement jfku_edit_announc">
	<div class="kheader">
	...
	<div class="kcontainer" id="kannouncement">
		...
		<div class="kbody">
			<div class="kanndesc">
				...
				<div>
					<label>
						<span class="jfku_edit_announc_title_txt"><?php echo JText::_('COM_KUNENA_ANN_TITLE') ?></span>
						<?php echo $this->displayInput('title', 'class="klarge required"') ?>
					</label>
					<label>
						<span class="jfku_edit_announc_title_txt"><?php echo JText::_('COM_KUNENA_ANN_SORTTEXT') ?></span>
						<?php echo $this->displayInput('sdescription', 'class="ksmall required" rows="80" cols="4"') ?>
					</label>
				</div>
				<div>
					<label>
						<span class="jfku_edit_announc_title_txt"><?php echo JText::_('COM_KUNENA_ANN_LONGTEXT') ?></span>
