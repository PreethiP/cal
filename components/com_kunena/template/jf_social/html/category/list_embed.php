		...
		<tr class="k<?php echo $tabclass [$k ^= 1], isset ( $category->class_sfx ) ? ' k' . $this->escape($tabclass [$k]) . $this->escape($category->class_sfx) : '' ?>"
			...
			<td class="kcol-mid kcol-kcattitle">
				<div class="jf_ku_cat_title_sec">
					...
					<div class="jf_cat_descr jf_ku_tipsy_w_arial" original-title="<?php if (!empty($category->description)) : ?><?php echo KunenaHtmlParser::parseBBCode ($category->description) ?><?php endif; ?>"></div>
					<div class="clear"></div>
				</div>
