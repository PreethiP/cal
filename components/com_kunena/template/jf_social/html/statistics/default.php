...
<div class="kblock kpopsubjstats">
	<div class="kheader">
		<span class="ktoggler"><a class="ktoggler close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" rel="kpopsubstats-tbody <?php echo $top[0]->title ?>"></a></span>
		<h2><span><?php echo $top[0]->title ?></span></h2>
	</div>
	<div class="kcontainer" id="kpopsubstats-tbody <?php echo $top[0]->title ?>">
		<div class="kbody">
			<table class="kblocktable">
				<tbody>
					<tr class="ksth" >
					...
					<tr class="k<?php echo $this->escape($tabclass[$id & 1]); ?>">
						...
						<td class="kcol-mid">
							<span class="jf_ku_stat_bar jf_ku_tipsy_e_arial" original-title="<?php echo $item->percent ?>%">
								<span style="height:10px;width:<?php echo $item->percent ?>%"></span>
							</span>
						</td>
						<td class="kcol-last">
							<?php echo $item->count ?>
