					...
					<td>
						<div class="kpolldesc">
							...
							<tr class="krow<?php echo (++$row)%2+1;?>">
								...
								<td class="kcol-bar">
									<span class="jf_ku_stat_bar jf_ku_tipsy_w_arial" title="<?php echo round(($option->votes*100)/max($this->poll->getTotal(),1),1)."%"; ?>">
										<span style="height:10px;width:<?php echo intval(($option->votes*300)/max($this->poll->getTotal(),1))+3; ?>px"></span>
									</span>
								</td>
							...
							<?php endforeach; ?>
							<tr class="krow<?php echo (++$row)%2+1;?>">
								<td class="jf_ku_poll_total" colspan="4">
									<?php
