...
<form action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=category&limitstart=0&virtuemart_category_id=' . $this->category->virtuemart_category_id); ?>" method="get">
	...
	<div class="virtuemart_search">
		...
		<input name="keyword" class="inputbox" type="text" size="15" value="<?php echo $this->keyword ?>"/>
		...
		<div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?>">
			...
			<div class="spacer">
             ...
             <div class="jf_blue_series">
               ...
               <div class="jf_div_1 floatleft">

				    <!--Product image -->
                    
                    
                    <?php /** @todo make image popup */
							echo '<a href="' . $product->images[0]->file_url_thumb . '" title="' . $product->product_name . '" class="pirobox" , rel="gallery" ><img src="' . $product->images[0]->file_url_thumb . '" alt="' . $product->product_name . '" /></a>';
   ...
   <!-- Product Description -->
					...
					if (!empty($product->product_desc)) {
						...
						<p class="product_desc">
							...
							<?php echo shopFunctionsF::limitStringByWord ($product->product_desc, 800, '...') ?>
