...
<div id="k2Container" class="jf-k2-layout2 itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
					...
					<div class="jf-k2-item-zoom-sec">
						<div class="jf-k2-item-zoom-block">
							<div class="jf-k2-item-zoom">
								<a class="pirobox_gall" rel="gallery" href="<?php echo $this->item->imageXLarge; ?>"></a>
								<!-- Sample Modal
									<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>"></a>
								-->
							</div>
						</div>
					</div>
					<div class="jf-k2-item-date">
						<?php if($this->item->params->get('itemDateCreated')): ?>
							...
							<span class="catItemDateCreated">
								<?php echo JHTML::_('date', $this->item->created , JText::_('JF_K2_STYLE1_DATE_FORMAT_LC3_PART1')); ?><br />
								<?php echo JHTML::_('date', $this->item->created , JText::_('JF_K2_STYLE1_DATE_FORMAT_LC3_PART2')); ?>
							</span>
						<?php endif; ?>
					</div>
	...
	<!-- Social sharing -->
	<div class="itemSocialSharing jf-tipsy-e" title="<?php echo JText::_('JF_K2_SOCIAL_SHARE'); ?>">
  ...
  <div class="itemLinks jf-k2-user-ItemLinks">
	  ...
	  <!-- Item tags -->
	  <div class="itemTagsBlock jf-k2-TagsBlock jf-tipsy-e" title="<?php echo JText::_('K2_TAGGED_UNDER'); ?>">
  ...
  <!-- Author Block -->
  <div class="itemAuthorBlock jf-k2-userBlock">

  	<?php if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>
  	<img class="itemAuthorAvatar" width="100px" src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
  	<?php endif; ?>
	...
	<?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
		...
		<div class="itemComments">
			...
			<?php if($this->item->numOfComments>0 && $this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2'))): ?>
				<div class="jf-k2-comment-separator">
					<div class="jf-k2-comment-separator-icon"></div>
				</div>
				...
				<div class="itemCommentsPagination jf-k2-Pagination">
