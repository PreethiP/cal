...
<div id="k2Container" class="jf-k2-userView jf-k2-layout2 userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
						...
						<div class="jf-k2-item-zoom-sec">
							<div class="jf-k2-item-zoom-block">
								<div class="jf-k2-item-zoom">
									<a class="pirobox_gall" rel="gallery" href="<?php echo $item->imageXLarge; ?>"></a>
									<!-- Sample Modal
