...
<div id="jf-login">
	<?php if ($type == 'logout') : ?>
		...
		<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="jf-logged">
			<div class="jf-login-greeting">
				<div class="jf-login-greeting-toggler">
					<?php if ($params->get('greeting')) : ?>
						...
						<?php if($params->get('name') == 0) : {
							...
							<span class="jf-login-imp-icon"></span>
						</div>
					<?php endif; ?>
				</div>
			</div>
			<div class="jf-login-loggedcont s-joomla-v">
				<div class="jf-login-loggedcont-bg">
					<div class="jf-login-loggedcont-tick"></div>
					<div class="jf-login-loggedcont-loader">
	...
	<?php else : ?>
			...
			<a class="jf-login-button jf-tipsy-n" title="<?php echo JText::_('JF_CLICK_TO_LOGIN'); ?>">
				<span></span>
			</a>
			<div class="jf-login-content">
				...
				<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
					...
					<fieldset class="userdata">
						...
						<?php endif; ?>
						<input type="submit" name="Submit" class="jf-login-authorization-button" value="<?php echo JText::_('JLOGIN') ?>" />
						<input type="hidden" name="option" value="com_users" />
